...
<title>Custom queries. | B.arguest.</title>
</head>
...
<div class="form-group">
	...
	<textarea class="form-control" rows="8" default="select * from bars" id="query" name="query"></textarea>
</div>
...
<%
		...
		resultMain = statement.executeQuery(query);
